...
#	theta2 = theta2+theta1 # because we are using belts
	...
	# Make sure that theta2 angle starts always form the same reference axis
	# Otherwise when it exeeds 90° it changes reference axis
	'''
...
# Define points of a trajectory

'''
# (until the robot receives the last_point=1 and then executes the trajectory) [max 50 points]
